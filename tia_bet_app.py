...
if aba == "📌 Palpite de Hoje":
    ...
    # Cálculo de ROI e acerto
    entrada_fixa = 100
    acertos = df_filtrado[df_filtrado["resultado"] == "Ganho"]
    erros = df_filtrado[df_filtrado["resultado"] == "Perdido"]
    push = df_filtrado[df_filtrado["resultado"] == "Push"]
    ...
    # Gráfico de barras por resultado
    ...
    fig_resultado = px.bar(resultado_count, x="Resultado", y="Quantidade", color="Resultado", title="Distribuição de Resultados")
    ...
    # Gráfico de linha EV ao longo do tempo
